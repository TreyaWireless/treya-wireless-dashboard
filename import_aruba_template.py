...
yaml_path = 'aruba_custom.yaml'
if not os.path.exists(yaml_path):
    yaml_path = '/home/ec2-user/treya-wireless-dashboard/aruba_custom.yaml'
...
print("Importing custom Aruba Controller template...")
import_payload = {
    "jsonrpc": "2.0",
...
try:
    ...
    with urllib.request.urlopen(req) as response:
        ...
        if "error" in res:
            ...
            print("======================================================")
            print(" Template 'Aruba Controller Custom API'")
