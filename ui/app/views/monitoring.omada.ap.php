...
$filter_html = <<<HTML
<form method="get" action="zabbix.php" name="ap_filter_form" id="ap_filter_form">
...
document.addEventListener("DOMContentLoaded", () => {
	...
	function renderApList() {
		...
		filtered.forEach(ap => {
			...
			// Determinisitc mock data for channel/utils based on MAC to look extremely realistic
	...
	document.getElementById("btn-reset-filter").addEventListener("click", () => {
		window.location.href = 'zabbix.php?action=omada.ap';
	});
