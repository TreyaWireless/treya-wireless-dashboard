...
class CRouter {
	...
	private array $routes = [
		...
		'omada.devices'								=> [CControllerOmadaDevices::class,									'layout.json',			null],
		'omada.ap'									=> [CControllerOmadaAp::class,										'layout.htmlpage',		'monitoring.omada.ap'],
		...
		'omada.rf_dashboard'						=> [CControllerOmadaRfDashboard::class,								'layout.htmlpage',		'monitoring.omada.rf_dashboard'],
